...
* Runs function 
global data_choice "CEX_all_q"
cap do prep_actualCEX
...
// 				matrix `var'se[`h'+1,1] = round(_se[d.f_hat_demeaned], $rounding)
			...
			graph export "consum`z'_f_hat_$data_choice.pdf", replace
			...
			graph export "consum`z'_mp_$data_choice.pdf", replace
			...
			graph export "consum`z'_mpfp_$data_choice.pdf", replace
