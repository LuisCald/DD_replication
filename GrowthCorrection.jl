...
##########################################################################################################################################
SCF =  DataFrame(XLSX.readtable(raw"/Users/lc/Dropbox/Distributional_Dynamics/2_Data_processing/SCF_nogrowth.xlsx", "data", header=true,))

for c in [:income, :wealth, :assets, :finast, :illiqd, :liquid, :tdebt, :pdebt, :hdebt, :hhequiv, :weight]
    # coalesce
...
wealth  = SCF[:, [:id, :year, :weight, :wealth, :assets, :finast, :illiqd, :liquid, :tdebt, :pdebt, :hdebt, :hhequiv]]
...
# Create date columns 
gdp_con[!, :date] = QuarterlyDate.(gdp_con[!, "daten"])
...
# Save file to XLSX 
CSV.write(raw"/Users/lc/Dropbox/Distributional_Dynamics/2_Data_processing/SCF.csv", final_df)

# Read in the same file using CSV
b = CSV.read(raw"/Users/lc/Dropbox/Distributional_Dynamics/2_Data_processing/SCF.csv", DataFrame)
...
# Save file to csv
CSV.write(raw"/Users/lc/Dropbox/Distributional_Dynamics/2_Data_processing/SCF.csv", b)
