...
# ─────────────────────────────────────────────────────────────
#
# Standalone: reconstructs the smoothed factors at a sample of posterior
# θ-draws and writes data/synthetic/smoothed_factor_draws.csv (+ bands).
# Reads the DIME output that Stage 2 already wrote to
...
#   # optional: DD_N_DRAWS=400 julia --project=code/julia/env code/julia/export_draws.jl
#
