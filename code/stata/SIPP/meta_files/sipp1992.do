log using sip92fp, text replace
set mem 1000m
*This program reads the 1992 SIPP Full Panel Data File 
...
*by Jean Roth Mon Jun  7 18:35:43 EDT 2004
*Please report errors to jroth@nber.org
*run with do sip92fp
*Change output file name/location as desired in the first line of the .dct file
*If you are using a PC, you may need to change the direction of the slashes, as in C:\
*  or "\\Nber\home\data\sipp\1992\sip92fp.dat"
...
;
label values pp_int01 pp_int; 
label values pp_int02 pp_int; 
label values pp_int03 pp_int; 
label values pp_int04 pp_int; 
label values pp_int05 pp_int; 
label values pp_int06 pp_int; 
label values pp_int07 pp_int; 
label values pp_int08 pp_int; 
label values pp_int09 pp_int; 
label values pp_int10 pp_int; 
label define pp_int  
...
label values pp_mis37 pp_mis; 
label values pp_mis38 pp_mis; 
label values pp_mis39 pp_mis; 
label values pp_mis40 pp_mis; 
label define pp_mis  
	0           "Not matched or not in sample"  
	1           "Interview"                     
	2           "Non-interview"                 
;
label values reasle01 reasle; 
label values reasle02 reasle; 
label values reasle03 reasle; 
label values reasle04 reasle; 
label values reasle05 reasle; 
label values reasle06 reasle; 
label values reasle07 reasle; 
label values reasle08 reasle; 
label values reasle09 reasle; 
label values reasle10 reasle; 
label define reasle  
...
label values hhinst37 hhinst; 
label values hhinst38 hhinst; 
label values hhinst39 hhinst; 
label values hhinst40 hhinst; 
label define hhinst  
...
label values lgthht37 lgthht; 
label values lgthht38 lgthht; 
label values lgthht39 lgthht; 
label values lgthht40 lgthht; 
label define lgthht  
...
label values lgtkey37 lgtkey; 
label values lgtkey38 lgtkey; 
label values lgtkey39 lgtkey; 
label values lgtkey40 lgtkey; 
label define lgtkey  
...
label values lgtoth37 lgtoth; 
label values lgtoth38 lgtoth; 
label values lgtoth39 lgtoth; 
label values lgtoth40 lgtoth; 
label define lgtoth  
...
label values rrp_37   rrp;    
label values rrp_38   rrp;    
label values rrp_39   rrp;    
label values rrp_40   rrp;    
label define rrp     
...
label values age_37   age;    
label values age_38   age;    
label values age_39   age;    
label values age_40   age;    
label define age     
...
label values ms_37    ms;     
label values ms_38    ms;     
label values ms_39    ms;     
label values ms_40    ms;     
label define ms      
	0           "Not a sample person in this"   
...
label values famtyp37 famtyp; 
label values famtyp38 famtyp; 
label values famtyp39 famtyp; 
label values famtyp40 famtyp; 
label define famtyp  
...
label values famrel37 famrel; 
label values famrel38 famrel; 
label values famrel39 famrel; 
label values famrel40 famrel; 
label define famrel  
...
label values famnum37 famnum; 
label values famnum38 famnum; 
label values famnum39 famnum; 
label values famnum40 famnum; 
label define famnum  
	0           "Not applicable, not in sample,"
;
...
label values pnsp_37  pnsp;   
label values pnsp_38  pnsp;   
label values pnsp_39  pnsp;   
label values pnsp_40  pnsp;   
label define pnsp    
	0           "Not a sample person in this"   
	0999        "Not applicable"                
;
...
label values pnpt_37  pnpt;   
label values pnpt_38  pnpt;   
label values pnpt_39  pnpt;   
label values pnpt_40  pnpt;   
label define pnpt    
	0           "Not a sample person in this"   
	0999        "Not applicable"                
;
label values higrad01 higrad; 
label values higrad02 higrad; 
label values higrad03 higrad; 
label values higrad04 higrad; 
label values higrad05 higrad; 
label values higrad06 higrad; 
label values higrad07 higrad; 
label values higrad08 higrad; 
label values higrad09 higrad; 
label values higrad10 higrad; 
label define higrad  
	0           "Not applicable if under 15,"   
;
label values grd_cm01 grd_cm; 
label values grd_cm02 grd_cm; 
label values grd_cm03 grd_cm; 
label values grd_cm04 grd_cm; 
label values grd_cm05 grd_cm; 
label values grd_cm06 grd_cm; 
label values grd_cm07 grd_cm; 
label values grd_cm08 grd_cm; 
label values grd_cm09 grd_cm; 
label values grd_cm10 grd_cm; 
label define grd_cm  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
;
label values vetsta01 vetsta; 
label values vetsta02 vetsta; 
label values vetsta03 vetsta; 
label values vetsta04 vetsta; 
label values vetsta05 vetsta; 
label values vetsta06 vetsta; 
label values vetsta07 vetsta; 
label values vetsta08 vetsta; 
label values vetsta09 vetsta; 
label values vetsta10 vetsta; 
label define vetsta  
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
label values in_af_01 in_af;  
label values in_af_02 in_af;  
label values in_af_03 in_af;  
label values in_af_04 in_af;  
label values in_af_05 in_af;  
label values in_af_06 in_af;  
label values in_af_07 in_af;  
label values in_af_08 in_af;  
label values in_af_09 in_af;  
label values in_af_10 in_af;  
label define in_af   
	0           "Not applicable if under 15,"   
	1           "Yes"                           
	2           "No"                            
;
label values usrv1_01 usrv1l; 
label values usrv1_02 usrv1l; 
label values usrv1_03 usrv1l; 
label values usrv1_04 usrv1l; 
label values usrv1_05 usrv1l; 
label values usrv1_06 usrv1l; 
label values usrv1_07 usrv1l; 
label values usrv1_08 usrv1l; 
label values usrv1_09 usrv1l; 
label values usrv1_10 usrv1l; 
label define usrv1l  
	0           "Not applicable, not in sample,"
	...
	9           "Not answered"                  
;
label values usrv2_01 usrv2l; 
label values usrv2_02 usrv2l; 
label values usrv2_03 usrv2l; 
label values usrv2_04 usrv2l; 
label values usrv2_05 usrv2l; 
label values usrv2_06 usrv2l; 
label values usrv2_07 usrv2l; 
label values usrv2_08 usrv2l; 
label values usrv2_09 usrv2l; 
label values usrv2_10 usrv2l; 
label define usrv2l  
	0           "Not applicable, not in sample,"
	1           "Vietnam Era (Aug'64-Apr'75)"   
	2           "Korean Conflict (June'50-"     
	...
	9           "Not answered"                  
;
label values usrv3_01 usrv3l; 
label values usrv3_02 usrv3l; 
label values usrv3_03 usrv3l; 
label values usrv3_04 usrv3l; 
label values usrv3_05 usrv3l; 
label values usrv3_06 usrv3l; 
label values usrv3_07 usrv3l; 
label values usrv3_08 usrv3l; 
label values usrv3_09 usrv3l; 
label values usrv3_10 usrv3l; 
label define usrv3l  
	0           "Not applicable, not in sample,"
	1           "Vietnam era (Aug'64-Apr'75)"   
	2           "Korean Conflict (June'50-"     
...
label define u_brthyr
	-009        "Not answered"                  
;
label values u_pngd01 u_pngd; 
label values u_pngd02 u_pngd; 
label values u_pngd03 u_pngd; 
label values u_pngd04 u_pngd; 
label values u_pngd05 u_pngd; 
label values u_pngd06 u_pngd; 
label values u_pngd07 u_pngd; 
label values u_pngd08 u_pngd; 
label values u_pngd09 u_pngd; 
label values u_pngd10 u_pngd; 
label define u_pngd  
...
label values livqtr37 livqtr; 
label values livqtr38 livqtr; 
label values livqtr39 livqtr; 
label values livqtr40 livqtr; 
label define livqtr  
	0           "Not applicable, not in sample,"
...
label values tenure37 tenure; 
label values tenure38 tenure; 
label values tenure39 tenure; 
label values tenure40 tenure; 
label define tenure  
...
label values pubhou37 pubhou; 
label values pubhou38 pubhou; 
label values pubhou39 pubhou; 
label values pubhou40 pubhou; 
label define pubhou  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values low_re37 low_re; 
label values low_re38 low_re; 
label values low_re39 low_re; 
label values low_re40 low_re; 
label define low_re  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
;
label values engry_01 engry_; 
label values engry_02 engry_; 
label values engry_03 engry_; 
label values engry_04 engry_; 
label values engry_05 engry_; 
label values engry_06 engry_; 
label values engry_07 engry_; 
label values engry_08 engry_; 
label values engry_09 engry_; 
label values engry_10 engry_; 
label define engry_  
	0           "Not in universe, not in sample"
	1           "Yes"                           
	2           "No"                            
;
label values engryt01 engryt; 
label values engryt02 engryt; 
label values engryt03 engryt; 
label values engryt04 engryt; 
label values engryt05 engryt; 
label values engryt06 engryt; 
label values engryt07 engryt; 
label values engryt08 engryt; 
label values engryt09 engryt; 
label values engryt10 engryt; 
label define engryt  
	0           "Not applicable, not in sample" 
...
;
label values engrya01 engrya; 
label values engrya02 engrya; 
label values engrya03 engrya; 
label values engrya04 engrya; 
label values engrya05 engrya; 
label values engrya06 engrya; 
label values engrya07 engrya; 
label values engrya08 engrya; 
label values engrya09 engrya; 
label values engrya10 engrya; 
label define engrya  
	0           "Not in universe, not in sample"
;
label values typelu01 typelu; 
label values typelu02 typelu; 
label values typelu03 typelu; 
label values typelu04 typelu; 
label values typelu05 typelu; 
label values typelu06 typelu; 
label values typelu07 typelu; 
label values typelu08 typelu; 
label values typelu09 typelu; 
label values typelu10 typelu; 
label define typelu  
	0           "Not applicable, not in sample" 
	1           "Free"                          
	2           "Reduced-price"                 
	3           "Both"                          
;
label values num_lu01 num_lu; 
label values num_lu02 num_lu; 
label values num_lu03 num_lu; 
label values num_lu04 num_lu; 
label values num_lu05 num_lu; 
label values num_lu06 num_lu; 
label values num_lu07 num_lu; 
label values num_lu08 num_lu; 
label values num_lu09 num_lu; 
label values num_lu10 num_lu; 
label define num_lu  
	0           "Not in universe, not in sample"
;
label values typebr01 typebr; 
label values typebr02 typebr; 
label values typebr03 typebr; 
label values typebr04 typebr; 
label values typebr05 typebr; 
label values typebr06 typebr; 
label values typebr07 typebr; 
label values typebr08 typebr; 
label values typebr09 typebr; 
label values typebr10 typebr; 
label define typebr  
	0           "Not applicable, not in sample" 
	1           "Free"                          
	2           "Reduced-price"                 
	3           "Both"                          
;
label values num_br01 num_br; 
label values num_br02 num_br; 
label values num_br03 num_br; 
label values num_br04 num_br; 
label values num_br05 num_br; 
label values num_br06 num_br; 
label values num_br07 num_br; 
label values num_br08 num_br; 
label values num_br09 num_br; 
label values num_br10 num_br; 
label define num_br  
	0           "Not in universe, not in sample"
;
...
label define utlpayyn
	...
	2           "No"                            
;
label values geo_st01 geo_st; 
label values geo_st02 geo_st; 
label values geo_st03 geo_st; 
label values geo_st04 geo_st; 
label values geo_st05 geo_st; 
label values geo_st06 geo_st; 
label values geo_st07 geo_st; 
label values geo_st08 geo_st; 
label values geo_st09 geo_st; 
label values geo_st10 geo_st; 
label define geo_st  
	0           "Nonmatch"                      
	1           "Alabama"                       
	4           "Arizona"                       
...
label define sc1456l 
	...
	3           "No"                            
;
label values medcode1 medcode;
label values medcode2 medcode;
...
;
label values att_sc01 att_sc; 
label values att_sc02 att_sc; 
label values att_sc03 att_sc; 
label values att_sc04 att_sc; 
label values att_sc05 att_sc; 
label values att_sc06 att_sc; 
label values att_sc07 att_sc; 
label values att_sc08 att_sc; 
label values att_sc09 att_sc; 
label values att_sc10 att_sc; 
label define att_sc  
	0           "Not in universe"               
	1           "Yes, full-time"                
	2           "Yes, part-time"                
...
label values enrl_m37 enrl_m; 
label values enrl_m38 enrl_m; 
label values enrl_m39 enrl_m; 
label values enrl_m40 enrl_m; 
label define enrl_m  
	0           "Not enrolled, not in universe,"
	1           "Enrolled during that month"    
;
label values ed_lev01 ed_lev; 
label values ed_lev02 ed_lev; 
label values ed_lev03 ed_lev; 
label values ed_lev04 ed_lev; 
label values ed_lev05 ed_lev; 
label values ed_lev06 ed_lev; 
label values ed_lev07 ed_lev; 
label values ed_lev08 ed_lev; 
label values ed_lev09 ed_lev; 
label values ed_lev10 ed_lev; 
label define ed_lev  
	0           "Not in universe, not in"       
	...
	11          "Business school"               
;
label values ed_fin01 ed_fin; 
label values ed_fin02 ed_fin; 
label values ed_fin03 ed_fin; 
label values ed_fin04 ed_fin; 
label values ed_fin05 ed_fin; 
label values ed_fin06 ed_fin; 
label values ed_fin07 ed_fin; 
label values ed_fin08 ed_fin; 
label values ed_fin09 ed_fin; 
label values ed_fin10 ed_fin; 
label define ed_fin  
	0           "Not in universe"               
	1           "Yes"                           
	2           "No"                            
;
label values sc169601 sc1696l;
label values sc169602 sc1696l;
label values sc169603 sc1696l;
label values sc169604 sc1696l;
label values sc169605 sc1696l;
label values sc169606 sc1696l;
label values sc169607 sc1696l;
label values sc169608 sc1696l;
label values sc169609 sc1696l;
label values sc169610 sc1696l;
...
label values wavflg37 wavflg; 
label values wavflg38 wavflg; 
label values wavflg39 wavflg; 
label values wavflg40 wavflg; 
label define wavflg  
	0           "Not imputed"                   
...
label values esr_37   esr;    
label values esr_38   esr;    
label values esr_39   esr;    
label values esr_40   esr;    
label define esr     
	0           "Not applicable, not in sample,"
...
label values wksper37 wksper; 
label values wksper38 wksper; 
label values wksper39 wksper; 
label values wksper40 wksper; 
label define wksper  
	0           "Not applicable, not in sample,"
	4           "Four weeks"                    
	5           "Five weeks"                    
...
label values mthjbw37 mthjbw; 
label values mthjbw38 mthjbw; 
label values mthjbw39 mthjbw; 
label values mthjbw40 mthjbw; 
label define mthjbw  
...
label values mthwop37 mthwop; 
label values mthwop38 mthwop; 
label values mthwop39 mthwop; 
label values mthwop40 mthwop; 
label define mthwop  
	0           "0 weeks or not applicable, not"
	1           "1 week"                        
	2           "2 weeks"                       
...
label values mthwks37 mthwks; 
label values mthwks38 mthwks; 
label values mthwks39 mthwks; 
label values mthwks40 mthwks; 
label define mthwks  
	...
	5           "5 weeks (only applicable for"  
;
label values usualh01 usualh; 
label values usualh02 usualh; 
label values usualh03 usualh; 
label values usualh04 usualh; 
label values usualh05 usualh; 
label values usualh06 usualh; 
label values usualh07 usualh; 
label values usualh08 usualh; 
label values usualh09 usualh; 
label values usualh10 usualh; 
label define usualh  
	0           "Not in universe"               
	-3          "None"                          
;
...
label values jobid137 jobid1l;
label values jobid138 jobid1l;
label values jobid139 jobid1l;
label values jobid140 jobid1l;
...
label values jobid237 jobid2l;
label values jobid238 jobid2l;
label values jobid239 jobid2l;
label values jobid240 jobid2l;
...
label values clswk133 clswk1l;
label values clswk134 clswk1l;
label values clswk135 clswk1l;
label values clswk136 clswk1l;
label values clswk137 clswk1l;
label values clswk138 clswk1l;
label values clswk139 clswk1l;
label values clswk140 clswk1l;
...
label values clswk237 clswk2l;
label values clswk238 clswk2l;
label values clswk239 clswk2l;
label values clswk240 clswk2l;
...
label values wksem137 wksem1l;
label values wksem138 wksem1l;
label values wksem139 wksem1l;
label values wksem140 wksem1l;
...
label values wksem237 wksem2l;
label values wksem238 wksem2l;
label values wksem239 wksem2l;
label values wksem240 wksem2l;
...
label values wshrs137 wshrs1l;
label values wshrs138 wshrs1l;
label values wshrs139 wshrs1l;
label values wshrs140 wshrs1l;
...
label values wshrs237 wshrs2l;
label values wshrs238 wshrs2l;
label values wshrs239 wshrs2l;
label values wshrs240 wshrs2l;
...
label values hrrat137 hrrat1l;
label values hrrat138 hrrat1l;
label values hrrat139 hrrat1l;
label values hrrat140 hrrat1l;
...
label values hrrat237 hrrat2l;
label values hrrat238 hrrat2l;
label values hrrat239 hrrat2l;
label values hrrat240 hrrat2l;
...
label values busid137 busid1l;
label values busid138 busid1l;
label values busid139 busid1l;
label values busid140 busid1l;
...
label values busid237 busid2l;
label values busid238 busid2l;
label values busid239 busid2l;
label values busid240 busid2l;
...
label values typbs137 typbs1l;
label values typbs138 typbs1l;
label values typbs139 typbs1l;
label values typbs140 typbs1l;
...
label values typbs237 typbs2l;
label values typbs238 typbs2l;
label values typbs239 typbs2l;
label values typbs240 typbs2l;
...
label values se_wb133 se_wb1l;
label values se_wb134 se_wb1l;
label values se_wb135 se_wb1l;
label values se_wb136 se_wb1l;
label values se_wb137 se_wb1l;
label values se_wb138 se_wb1l;
label values se_wb139 se_wb1l;
label values se_wb140 se_wb1l;
...
label values se_wb237 se_wb2l;
label values se_wb238 se_wb2l;
label values se_wb239 se_wb2l;
label values se_wb240 se_wb2l;
...
label values se_hr133 se_hr1l;
label values se_hr134 se_hr1l;
label values se_hr135 se_hr1l;
label values se_hr136 se_hr1l;
label values se_hr137 se_hr1l;
label values se_hr138 se_hr1l;
label values se_hr139 se_hr1l;
label values se_hr140 se_hr1l;
...
label values se_hr237 se_hr2l;
label values se_hr238 se_hr2l;
label values se_hr239 se_hr2l;
label values se_hr240 se_hr2l;
...
label define g1src10l
	...
	75          "State SSI/Black Lung/State"    
;
label values ssreci01 ssreci; 
label values ssreci02 ssreci; 
label values ssreci03 ssreci; 
label values ssreci04 ssreci; 
label values ssreci05 ssreci; 
label values ssreci06 ssreci; 
label values ssreci07 ssreci; 
label values ssreci08 ssreci; 
label values ssreci09 ssreci; 
label values ssreci10 ssreci; 
label define ssreci  
	0           "Not in universe"               
...
;
label values rrreci01 rrreci; 
label values rrreci02 rrreci; 
label values rrreci03 rrreci; 
label values rrreci04 rrreci; 
label values rrreci05 rrreci; 
label values rrreci06 rrreci; 
label values rrreci07 rrreci; 
label values rrreci08 rrreci; 
label values rrreci09 rrreci; 
label values rrreci10 rrreci; 
label define rrreci  
	0           "Not in universe"               
	1           "Adult benefits received in own"
	2           "Only adult benefits received"  
...
label define sc3060l 
	...
	-1          "Dk"                            
;
label values ast15001 ast150l;
label values ast15002 ast150l;
label values ast15003 ast150l;
label values ast15004 ast150l;
label values ast15005 ast150l;
label values ast15006 ast150l;
label values ast15007 ast150l;
label values ast15008 ast150l;
label values ast15009 ast150l;
label values ast15010 ast150l;
label define ast150l 
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
;
label values g2src140 g2src14i;
label define g2src14i
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
;
...
label values careco37 careco; 
label values careco38 careco; 
label values careco39 careco; 
label values careco40 careco; 
label define careco  
...
label values caidco37 caidco; 
label values caidco38 caidco; 
label values caidco39 caidco; 
label values caidco40 caidco; 
label define caidco  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values wiccov37 wiccov; 
label values wiccov38 wiccov; 
label values wiccov39 wiccov; 
label values wiccov40 wiccov; 
label define wiccov  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values afdc_37  afdc;   
label values afdc_38  afdc;   
label values afdc_39  afdc;   
label values afdc_40  afdc;   
label define afdc    
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values foodst37 foodst; 
label values foodst38 foodst; 
label values foodst39 foodst; 
label values foodst40 foodst; 
label define foodst  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values gen_as37 gen_as; 
label values gen_as38 gen_as; 
label values gen_as39 gen_as; 
label values gen_as40 gen_as; 
label define gen_as  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values fost_k37 fost_k; 
label values fost_k38 fost_k; 
label values fost_k39 fost_k; 
label values fost_k40 fost_k; 
label define fost_k  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values oth_we37 oth_we; 
label values oth_we38 oth_we; 
label values oth_we39 oth_we; 
label values oth_we40 oth_we; 
label define oth_we  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values soc_se37 soc_se; 
label values soc_se38 soc_se; 
label values soc_se39 soc_se; 
label values soc_se40 soc_se; 
label define soc_se  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values railro37 railro; 
label values railro38 railro; 
label values railro39 railro; 
label values railro40 railro; 
label define railro  
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values vets_37  vets;   
label values vets_38  vets;   
label values vets_39  vets;   
label values vets_40  vets;   
label define vets    
	0           "Not applicable, not in sample,"
	1           "Yes"                           
	2           "No"                            
...
label values champ_37 champ;  
label values champ_38 champ;  
label values champ_39 champ;  
label values champ_40 champ;  
label define champ   
	0           "Not applicable"                
	1           "Yes"                           
	2           "No"                            
...
label values hiownc37 hiownc; 
label values hiownc38 hiownc; 
label values hiownc39 hiownc; 
label values hiownc40 hiownc; 
label define hiownc  
	0           "Not in universe, not in"       
...
label values hi_otc37 hi_otc; 
label values hi_otc38 hi_otc; 
label values hi_otc39 hi_otc; 
label values hi_otc40 hi_otc; 
label define hi_otc  
	0           "Not in universe, not in"       
...
label values hiempl37 hiempl; 
label values hiempl38 hiempl; 
label values hiempl39 hiempl; 
label values hiempl40 hiempl; 
label define hiempl  
	0           "Not in universe, not in"       
...
label values ss_pid37 ss_pid; 
label values ss_pid38 ss_pid; 
label values ss_pid39 ss_pid; 
label values ss_pid40 ss_pid; 
label define ss_pid  
	0           "Not in universe, not in"       
;
...
label values rr_pid37 rr_pid; 
label values rr_pid38 rr_pid; 
label values rr_pid39 rr_pid; 
label values rr_pid40 rr_pid; 
label define rr_pid  
	0           "Not in universe, not in"       
;
...
label values va_pid37 va_pid; 
label values va_pid38 va_pid; 
label values va_pid39 va_pid; 
label values va_pid40 va_pid; 
label define va_pid  
	0           "Not in universe, not in"       
;
...
label values afdcpi37 afdcpi; 
label values afdcpi38 afdcpi; 
label values afdcpi39 afdcpi; 
label values afdcpi40 afdcpi; 
label define afdcpi  
	0           "Not in universe, not in"       
;
...
label values ga_pid37 ga_pid; 
label values ga_pid38 ga_pid; 
label values ga_pid39 ga_pid; 
label values ga_pid40 ga_pid; 
label define ga_pid  
	0           "Not in universe, not in"       
;
...
label values fostpi37 fostpi; 
label values fostpi38 fostpi; 
label values fostpi39 fostpi; 
label values fostpi40 fostpi; 
label define fostpi  
	0           "Not in universe, not in"       
;
...
label values oth_pi37 oth_pi; 
label values oth_pi38 oth_pi; 
label values oth_pi39 oth_pi; 
label values oth_pi40 oth_pi; 
label define oth_pi  
	0           "Not in universe, not in"       
;
...
label values wic_pi37 wic_pi; 
label values wic_pi38 wic_pi; 
label values wic_pi39 wic_pi; 
label values wic_pi40 wic_pi; 
label define wic_pi  
	0           "Not in universe, not in"       
;
...
label values fs_pid37 fs_pid; 
label values fs_pid38 fs_pid; 
label values fs_pid39 fs_pid; 
label values fs_pid40 fs_pid; 
label define fs_pid  
	0           "Not in universe, not in"       
;
...
label values ws_i1_37 ws_i1l; 
label values ws_i1_38 ws_i1l; 
label values ws_i1_39 ws_i1l; 
label values ws_i1_40 ws_i1l; 
label define ws_i1l  
...
label values ws_i2_37 ws_i2l; 
label values ws_i2_38 ws_i2l; 
label values ws_i2_39 ws_i2l; 
label values ws_i2_40 ws_i2l; 
label define ws_i2l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values se_i1_37 se_i1l; 
label values se_i1_38 se_i1l; 
label values se_i1_39 se_i1l; 
label values se_i1_40 se_i1l; 
label define se_i1l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values se_i2_37 se_i2l; 
label values se_i2_38 se_i2l; 
label values se_i2_39 se_i2l; 
label values se_i2_40 se_i2l; 
label define se_i2l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i1_37 g1_i1l; 
label values g1_i1_38 g1_i1l; 
label values g1_i1_39 g1_i1l; 
label values g1_i1_40 g1_i1l; 
label define g1_i1l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i2_37 g1_i2l; 
label values g1_i2_38 g1_i2l; 
label values g1_i2_39 g1_i2l; 
label values g1_i2_40 g1_i2l; 
label define g1_i2l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i3_37 g1_i3l; 
label values g1_i3_38 g1_i3l; 
label values g1_i3_39 g1_i3l; 
label values g1_i3_40 g1_i3l; 
label define g1_i3l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i4_37 g1_i4l; 
label values g1_i4_38 g1_i4l; 
label values g1_i4_39 g1_i4l; 
label values g1_i4_40 g1_i4l; 
label define g1_i4l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i5_37 g1_i5l; 
label values g1_i5_38 g1_i5l; 
label values g1_i5_39 g1_i5l; 
label values g1_i5_40 g1_i5l; 
label define g1_i5l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i6_37 g1_i6l; 
label values g1_i6_38 g1_i6l; 
label values g1_i6_39 g1_i6l; 
label values g1_i6_40 g1_i6l; 
label define g1_i6l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i7_37 g1_i7l; 
label values g1_i7_38 g1_i7l; 
label values g1_i7_39 g1_i7l; 
label values g1_i7_40 g1_i7l; 
label define g1_i7l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i8_37 g1_i8l; 
label values g1_i8_38 g1_i8l; 
label values g1_i8_39 g1_i8l; 
label values g1_i8_40 g1_i8l; 
label define g1_i8l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i9_37 g1_i9l; 
label values g1_i9_38 g1_i9l; 
label values g1_i9_39 g1_i9l; 
label values g1_i9_40 g1_i9l; 
label define g1_i9l  
	0           "No imputations, not"           
	1           "Monthly amount imputed"        
;
...
label values g1_i1037 g1_i10l;
label values g1_i1038 g1_i10l;
label values g1_i1039 g1_i10l;
label values g1_i1040 g1_i10l;
...
label values g2i14037 g2i140l;
label values g2i14038 g2i140l;
label values g2i14039 g2i140l;
label values g2i14040 g2i140l;
